...
public:
    ...
    NodeCollection<Ramp>::iterator find_worker_by_id(Element ID id){};
    NodeCollection<Ramp>::const_iterator find_worker_by_id(ElementID id){};
    NodeCollection<Ramp>::const_iterator worker_cbegin(){};
    NodeCollection<Ramp>::const_iterator worker_cend(){};

    void add_storehouse(Ramp&& ramp){};
    void remove_storehouse(ElementID id){};
    NodeCollection<Ramp>::iterator find_storehouse_by_id(Element ID id){};
    NodeCollection<Ramp>::const_iterator find_storehouse_by_id(ElementID id){};
